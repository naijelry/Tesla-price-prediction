...
# Define the function to predict high and low prices in a given date range
def predict_high_low_between_dates(df, model_high, model_low, start_date, end_date):
    ...
    for future_date in date_range:
        ...
        # Predict the high and low prices for the next day
        ...
        predicted_prices_list.append({'date': future_date, 'predicted_high': predicted_high, 'predicted_low': predicted_low})

        # Update the last predicted close price for the next iteration
        last_predicted_close = predicted_high  # Or you can use the predicted_low if you prefer
...
# Example: Predict for the date range Nov 11, 2024 to Nov 25, 2024
